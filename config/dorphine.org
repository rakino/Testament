...
#+begin_src kdl :tangle ../tangled/dorphine/niri.kdl
  ...
  binds {
          ...
          Mod+D           { spawn "$$bin/rofi$$" "-show" "combi"; }
...
#+begin_src nix :tangle ../tangled/dorphine/nixpkgs.nix
  (import (builtins.getFlake "github:NixOS/nixpkgs/ee48b147c18c7de1e6ec97dc74792be42724bed1") {})
#+end_src
...
#+begin_src scheme :noweb-ref package-nix
  ...
  (nix-shell-wrapper "element-desktop"
    '("element-desktop")
    #:expression (local-file (testament-file "dorphine/nixpkgs.nix"))
    #:run-command '("element-desktop" "--no-update"))
