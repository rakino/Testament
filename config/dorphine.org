    ...
    (list (shepherd-service
            ...
            (start
             #~(make-forkexec-constructor
                (list #$(file-append (spec->pkg "foot") "/bin/foot") "--server")))
            (stop #~(make-kill-destructor)))))
#+end_src

** gammastep
#+begin_src scheme :noweb-ref home-service
  (simple-service 'gammastep home-shepherd-service-type
    (list (shepherd-service
            (provision '(gammastep))
...
#+begin_src scheme :noweb-ref home-service
  (service home-mako-service-type
    (home-mako-configuration
      (config (local-file (testament-plain "mako.conf")))))
#+end_src
...
#+begin_src scheme :noweb-ref home-service
  (service home-swaybg-service-type
    (home-swaybg-configuration
      (background (local-file "../../Pictures/Pixez/101361103_p0.jpg"))))
#+end_src
