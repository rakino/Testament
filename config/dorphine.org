...
#+begin_src scheme :noweb-ref package-nix
  (nix-shell-wrapper "moor"
    '("github:NixOS/nixpkgs/714a5f8c4ead6b31148d829288440ed033ccc041#moor")
    #:run-command '("moor"))
#+end_src
...
TODO: Address locale issue.

#+begin_src scheme :noweb-ref package-nix
  (nix-shell-wrapper "nix-assets"
    '("github:NixOS/nixpkgs/714a5f8c4ead6b31148d829288440ed033ccc041#glibcLocales"))

  (nix-shell-wrapper "nocturne"
    '("github:NixOS/nixpkgs/714a5f8c4ead6b31148d829288440ed033ccc041#nocturne")
...
configurations, see also my previous modifications to
home-fontconfig-service-type.
...
#+begin_src scheme :noweb-ref package-nix
  (nix-shell-wrapper "prismlauncher"
    '("github:NixOS/nixpkgs/714a5f8c4ead6b31148d829288440ed033ccc041#prismlauncher")
