...
Extra kernel arguments for NVIDIA proprietary driver
#+begin_src scheme :noweb-ref kernel-argument
  ;; https://github.com/Frogging-Family/nvidia-all/blob/master/customization.cfg
...
#+begin_src conf :tangle ../tangled/dorphine/dotfiles/.config/modprobed-db.conf
  ...
  COLORS=light
  IGNORE=(nvidia nvidia_drm nvidia_modeset nvidia_uvm zfs)
#+end_src
...
#+begin_src scheme :tangle ../tangled/dorphine/dotfiles/.config/gdb/gdbinit
...
#+begin_src scheme :tangle ../tangled/dorphine/dotfiles/.guile
...
#+begin_src conf :tangle ../tangled/dorphine/dotfiles/.config/nano/naonrc
