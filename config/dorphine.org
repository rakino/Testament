...
*** noctalia-shell
NOTE: Run ~herd restart noctalia-shell~ after home environment reconfiguration.

#+begin_src scheme :noweb-ref home-service
  (service home-noctalia-shell-service-type)
#+end_src

Use <https://noctalia.dev/plugins/polkit-agent/> as Polkit agent.
...
#+begin_src conf :tangle ../tangled/dorphine/dotfiles/.config/fcitx5/profile
  [Groups/0]
  Name=Default
