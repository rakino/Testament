...
#+begin_src scheme :noweb-ref package-nix
  (nix-shell-wrapper "nocturne"
    '("github:NixOS/nixpkgs/nixos-26.05#coreutils"
      "github:NixOS/nixpkgs/nixos-26.05#nocturne")
    #:run-command '("env" "LANG=C.UTF-8" "nocturne"))

  (nix-shell-wrapper "readest"
    '("github:NixOS/nixpkgs/nixos-26.05#coreutils"
      "github:NixOS/nixpkgs/nixos-26.05#readest")
    #:run-command '("env" "LANG=C.UTF-8" "readest"))
#+end_src
