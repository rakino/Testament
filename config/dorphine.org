...
#+begin_src scheme :tangle dorphine.scm :noweb yes
  ...
  ((compose (nonguix-transformation-nvidia #:s0ix-power-management? #t
    ...
    (home-niri-configuration
      (config
       (computed-substitution-with-inputs "niri.kdl"
         ...
         (specs->pkgs "wezterm" "xwayland-satellite")))))
#+end_src
...
#+begin_src scheme :noweb-ref service
  (simple-service 'niri-nvidia-profile etc-service-type
    `(("nvidia/nvidia-application-profiles-rc.d/50-limit-free-buffer-pool-in-wayland-compositors.json"
       ,(local-file (testament-plain "50-limit-free-buffer-pool-in-wayland-compositors.json")))))
#+end_src
