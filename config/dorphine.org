...
#+begin_src scheme :noweb-ref home-service
  (service home-gpg-agent-service-type
    (home-gpg-agent-configuration
      (pinentry-program (file-append bb-auth "/libexec/pinentry-bb"))
      (ssh-support? #t)))
#+end_src
...
Also install the Noctalia shell plugin: <https://github.com/anthonyhab/noctalia-plugins/blob/main/bb-auth/README.md>.
...
#+begin_src scheme :noweb-ref module
  ...
  (rosenthal packages authentication)
