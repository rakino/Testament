...
#+begin_src scheme :noweb-ref emacs-package
  (emacs-package
   (name 'mu4e)
   (package mu)
   (extra-packages (list emacs-message-view-patch))
   (options
    `((mu4e-sent-folder   . "/Sent")
      ...
      (mu4e-get-mail-command
       . ,#~(concat #$isync "/bin/mbsync -a --config "
                    #$(testament-file-object "mbsync.conf")))
      (mu4e-update-interval . ,(* 10 60))))
   (hooks '((gnus-part-display-hook . message-view-patch-highlight))))

  ;; Prefer text/plain.
  (emacs-package
   (name 'mm-decode)
   (extra-after-load
    (list #%(add-to-list 'mm-discouraged-alternatives "text/html")
