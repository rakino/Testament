...
** Networking & SSH
*** network-online
https://codeberg.org/guix/guix/issues/838#issue-1886438
#+begin_src scheme :noweb-ref home-service
  (simple-service 'home-network-online home-shepherd-service-type
  ...
  until /run/privileged/bin/ping -qc1 -W1 example.org
  do
      sleep 1
  done"))))))))
#+end_src
