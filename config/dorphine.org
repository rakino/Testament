...
#+begin_src scheme :noweb-ref file-systems
  (list (file-system
        ...
        (file-system
          ...
          (type "vfat"))
        (file-system
          (device "zfs:Mentha/Config")
          (mount-point "/etc")
          (type "zfs")
          (needed-for-boot? #t))
        (file-system
          (device "zfs:Mentha/Store")
          (mount-point "/gnu")
          (type "zfs")
          (needed-for-boot? #t))
        (file-system
          (device "zfs:Mentha/Home")
          (mount-point "/home")
          (type "zfs")))
#+end_src
...
#+begin_src scheme :noweb-ref home-environment-variable
  ...
  ("GUIX_SANDBOX_EXTRA_SHARES" . "$HOME/Downloads:$HOME/Pictures/Screenshots")
#+end_src
