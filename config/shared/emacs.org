...
Set up ElDoc integration.  https://www.masteringemacs.org/article/seamlessly-merge-multiple-documentation-sources-eldoc
...
Fix org-lint compatibility.  https://github.com/flycheck/flycheck/pull/2165#issuecomment-4537260684

#+begin_src elisp :noweb-ref emacs-init
  (use-package flycheck
    :config
    (defun hako/flycheck-checker-get-advice (orig checker property &rest rest)
      (if (and (eq 'org-lint checker)
               (eq 'start property)
        ...
        (apply orig checker property rest)))
    (advice-add #'flycheck-checker-get :around #'hako/flycheck-checker-get-advice))
#+end_src
