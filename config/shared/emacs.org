...
#+begin_src elisp :noweb-ref emacs-init
  (use-package emacs
    ...
    (word-wrap-by-category t)             ;better CJK support
    :config
    ...
    (after-init . pixel-scroll-precision-mode) ;scroll the display precisely
    (after-init . show-paren-mode)             ;visualize matching parenthesis
    (before-save . delete-trailing-whitespace)
    (prog-mode . display-fill-column-indicator-mode) ;`fill-column' indicator
    :bind
