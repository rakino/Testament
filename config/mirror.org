...
** Guix System
#+begin_src scheme :tangle ../files/tangled/mirror/mirror.scm :noweb yes
  (use-modules <<module>>)
      ...
      (caddyfile
       (computed-substitution-with-inputs (string-append mirror-name ".caddyfile")
         (plain-file "mirror.caddyfile"
           (string-join
            (list (file-content (testament-plain "mirror/mirror.caddyfile"))
                  (format #f "import $$caddy/~a.caddyfile$$" mirror-name))
            "\n"))
         (list (testament-plain "mirror/cache-sg.caddyfile")
               (testament-plain "mirror/cache-us-lax.caddyfile")
               ai-robots-txt)))))
#+end_src

See [[file:shared/caddy.org][shared/caddy.org]].

#+begin_src caddyfile :noweb yes :tangle ../files/tangled/mirror/mirror.caddyfile
  {
  	metrics
  	log {
...
*** mirroring
#+begin_src caddyfile :tangle ../files/tangled/mirror/cache-sg.caddyfile
...
#+begin_src caddyfile :tangle ../files/tangled/mirror/cache-us-lax.caddyfile
