...
Guix channels I'm using (personal forks are temporary, I'm not updating them
actively):
+ [[https://codeberg.org/guix/guix.git][guix]] ([[https://git.boiledscript.com/hako/guix.git][personal fork]])
+ [[https://gitlab.com/nonguix/nonguix][nonguix]] ([[https://git.boiledscript.com/hako/nonguix.git][personal fork]])
