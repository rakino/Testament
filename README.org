...
** [[file:config/chapra.org][chapra]] (x86_64-linux, server)

** [[file:config/gokuraku.org][gokuraku]] (x86_64-linux, server, build worker)
Head node of [[https://ci.boiledscript.com]].

** [[file:config/ignamma.org][ignamma]] (x86_64-linux, server, build worker)
