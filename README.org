...
Part of them are also used for the [[https://ultrarare.space/en/posts/guix-build-farm/][public Guix build farm and mirrors]] I run.
...
#+html: <img src="https://s3.boiledscript.com/misskey/29eb35e9-11fb-46b6-8b64-594f521b4309.webp">
#+html: <img src="https://s3.boiledscript.com/misskey/0d658beb-e5b2-418b-a7b6-e2882c906b61.webp">

** [[file:config/chapra.org][chapra]] (x86_64-linux, UEFI, ZFS) | [[file:files/deploy/chapra.scm][deploy]]

** [[file:config/gokuraku.org][gokuraku]] (x86_64-linux, UEFI, ZFS) | [[file:files/deploy/gokuraku.scm][deploy]]

** [[file:config/ignamma.org][ignamma]] (x86_64-linux, UEFI, XFS) | [[file:files/deploy/ignamma.scm][deploy]]

** [[file:config/rakuen.org][rakuen]] (aarch64-linux, UEFI, XFS) | [[file:files/deploy/rakuen.scm][deploy]]
